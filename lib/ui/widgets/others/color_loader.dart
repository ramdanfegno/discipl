...
class ColorLoader5 extends StatefulWidget {
  ...
  ColorLoader5(
      {
      //   this.dotOneColor = const Color(0xff05BC7F),
      // this.dotTwoColor = const Color(0xff05FC7F),
      // this.dotThreeColor = const Color(0xff00AC7F),
      this.dotOneColor = const Color.fromRGBO(233, 30, 35, 1),
      this.dotTwoColor = const Color.fromRGBO(160, 50, 50, 1),
      this.dotThreeColor = const Color.fromRGBO(233, 30, 35, 1),
