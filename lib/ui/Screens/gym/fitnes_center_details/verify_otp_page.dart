...
import 'package:habitoz_fitness_app/ui/widgets/dialog/status_dialog.dart';
...
class VerifyEnquiryOtpPage extends StatefulWidget {
  final UserRepository userRepository;
  final OtpResponse? otpResponseModel;
  final Function() onVerified;

  const VerifyEnquiryOtpPage(
  ...
  @override
  State<StatefulWidget> createState() => _VerifyEnquiryOtpPageState();
}

class _VerifyEnquiryOtpPageState extends State<VerifyEnquiryOtpPage> with CodeAutoFill {
  late Timer _timer;
  ...
  Future<bool> _onBackPressed() async {
    return showDialog(
        ...
        builder: (_) {
          return CustomDialog(
            title: 'Exit!',
            subtitle: 'Do you want to exit this process ? ',
            yesTitle: 'Yes',
            noTitle: 'No',
            yes: () {
              _timer.cancel();
