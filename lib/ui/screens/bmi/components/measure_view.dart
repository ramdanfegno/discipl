...
class TrianglePainter1 extends CustomPainter {
  ...
  TrianglePainter1({this.strokeColor = Colors.black, this.strokeWidth = 3, this.paintingStyle = PaintingStyle.stroke});
  ...
  @override
  bool shouldRepaint(TrianglePainter1 oldDelegate) {
...
class TrianglePainter2 extends CustomPainter {
  ...
  TrianglePainter2({this.strokeColor = Colors.black, this.strokeWidth = 3, this.paintingStyle = PaintingStyle.stroke});
  ...
  @override
  bool shouldRepaint(TrianglePainter2 oldDelegate) {
    return oldDelegate.strokeColor != strokeColor ||
        oldDelegate.paintingStyle != paintingStyle ||
        oldDelegate.strokeWidth != strokeWidth;
  }
