...
class HomePageModel {
  HomePageModel({this.content, this.profilePercentage, this.zone});
  ...
  factory HomePageModel.fromJson(Map<String, dynamic> json) => HomePageModel(
        ...
        profilePercentage: json["profile_percentage"] == null
            ? null
            : json["profile_percentage"],
        content: json["content"] == null
            ? null
            : List<HomePageModelContent>.from(
                json["content"].map((x) => HomePageModelContent.fromJson(x))),
      );
...
class HomePageModelContent {
  ...
  factory HomePageModelContent.fromJson(Map<String, dynamic> json) =>
      HomePageModelContent(
...
class ContentContent {
  ...
  factory ContentContent.fromJson(Map<String, dynamic> json) => ContentContent(
        ...
        amenities: json["amenities"] == null
            ? null
            : List<Amenities>.from(
                json["amenities"].map((x) => Amenities.fromJson(x))),
        ...
        rules: json["rules"] == null
            ? null
            : List<Amenities>.from(
                json["rules"].map((x) => Amenities.fromJson(x))),
        category: json["category"] == null
            ? null
            : List<Amenities>.from(
                json["category"].map((x) => Amenities.fromJson(x))),
        ...
        workingTime: json["working_time"] == null
            ...
            : List<WorkingTime>.from(
                json["working_time"].map((x) => WorkingTime.fromJson(x))),
        ...
        addressLine3:
            json["address_line3"] == null ? null : json["address_line3"],
        addressLine4:
            json["address_line4"] == null ? null : json["address_line4"],
        instagramUrl:
        ...
        fitnessCenter: json["fitness_center"] == null
            ? null
            : ZoneResult.fromJson(json["fitness_center"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "working_time": workingTime == null
            ? null
            : List<dynamic>.from(workingTime!.map((x) => x.toJson())),
        ...
        "fitness_center":
            fitnessCenter == null ? null : fitnessCenter!.toJson(),
        "km": km == null ? null : km,
      };
}
...
class Plan {
  ...
  factory Plan.fromJson(Map<String, dynamic> json) => Plan(
        ...
        isTrendingNow:
            json["is_trending_now"] == null ? null : json["is_trending_now"],
        fitnessCenter:
            json["fitness_center"] == null ? null : json["fitness_center"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "is_trending_now": isTrendingNow == null ? null : isTrendingNow,
