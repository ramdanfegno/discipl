...
FitnessCenterListModel fitnessCenterListModelFromJson(String str) =>
    FitnessCenterListModel.fromJson(json.decode(str));

String fitnessCenterListModelToJson(FitnessCenterListModel data) =>
...
class FitnessCenterListModel {
  ...
  factory FitnessCenterListModel.fromJson(Map<String, dynamic> json) =>
      FitnessCenterListModel(
        ...
        results: json["results"] == null
            ? null
            : List<FitnessCenterModel>.from(
                json["results"].map((x) => FitnessCenterModel.fromJson(x))),
      );
...
class FitnessCenterModel {
  ...
  factory FitnessCenterModel.fromJson(Map<String, dynamic> json) =>
      FitnessCenterModel(
