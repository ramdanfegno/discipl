...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  Stream<HomeState> _mapLoadHomeToState(
      bool forceRefresh, ZoneResult? zoneResult) async* {
    yield HomeFetchLoading();
    Response? response =
        await _productRepository.getHomePage(forceRefresh, zoneResult);
    if (response != null) {
      ...
      if (response.statusCode == 200) {
        ...
        yield HomeFetchSuccess(
            homeDate: homePageModel, isLoading: false, zone: zone);
