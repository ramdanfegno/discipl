...
class FCDetailBloc
    extends Bloc<FCDetailEvent, FCDetailState> {
  ...
  Stream<FCDetailState> _mapLoadDetailPageToState(bool forceRefresh,String? id) async* {
    try{
      yield FCDetailFetchLoading();
      Response? response = await _productRepository.getFitnessCenterDetail(forceRefresh,id!);
      if(response != null){
