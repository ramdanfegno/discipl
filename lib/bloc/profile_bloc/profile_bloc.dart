...
class ProfileBloc
  ...
  Stream<ProfileState> mapEventToState(ProfileEvent event) async* {
    if (event is LoadProfile) {
      ...
      yield* _mapUpdateProfileImageToState(event.details);
    }
  }
  ...
  Stream<ProfileState> _mapLoadProfileToState() async* {
    print('_mapLoadProfileToState');
      ...
      UserProfile? userProfile1 = null;//await _userRepository.getProfileDetailsLocal();
  ...
  Stream<ProfileState> _mapUpdateProfileImageToState(Map<String,dynamic> data) async* {
    try{
      UserProfile? userProfile1 = await _userRepository.getProfileDetailsLocal();
      UserProfile? userProfile2;
      if(userProfile1 != null){
      ...
      Response? response = await _userRepository.updateProfileImage(data);
      if(response != null){
        if(response.statusCode == 200){
          Response? response2 = await _userRepository.getUserProfile(true);
          if(response2 != null){
